# ADR-0006 — Pipeline RAG : .txt officiels → Qdrant (sans JSONL intermédiaire)
...
L'ancien pipeline utilisait des documents JSONL générés par Claude (288 docs) comme couche intermédiaire entre les programmes officiels et Qdrant. Ces JSONL étaient :
